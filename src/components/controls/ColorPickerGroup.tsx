    ...
    <div className={`flex flex-col gap-3 w-full ${disabled ? 'opacity-50 pointer-events-none' : ''}`}>
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1 text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors cursor-pointer"
        >
      ...
      <div className="relative flex items-center gap-2 p-1.5 bg-slate-100 dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-slate-700/60 flex-wrap">
          ...
          return (
            <div key={index} className="relative group">
              ...
              {isOpen && (
                <div
                  ref={popoverRef}
                  className="absolute top-10 left-0 z-50 p-2.5 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 flex flex-col gap-2 min-w-[160px]"
                >
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-20 px-1.5 py-1 text-xs font-mono font-medium rounded border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 uppercase outline-none focus:ring-1 focus:ring-indigo-500"
                    />
                  </div>
                </div>
              )}
        ...
        {colors.length < 6 && (
          <button
            ...
            className="w-8 h-8 rounded-lg border-2 border-dashed border-slate-300 dark:border-slate-600 hover:border-indigo-500 dark:hover:border-indigo-400 hover:bg-indigo-50/50 dark:hover:bg-indigo-950/30 text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center justify-center transition-all"
            title="Add color"
          >
